...
Flint checks if your project's folder contains the proper structure to allow potential contributors to understand: 1) what the projects mission is, 2) how to contribute, 3) under what conditions the project can be used, and 4) how to install the project.
